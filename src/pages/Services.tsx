...
import { registrationServices, brandServices, services, servicePath } from '@/data/services';
    ...
    <Seo
      ...
      jsonLd={{
        ...
        itemListElement: services.map((s, i) => ({
          ...
          position: i + 1,
          name: s.shortTitle,
          url: `https://tidybiz-startup-register.lovable.app${servicePath(s)}`,
        })),
      }}
    />
    ...
    <section className="bg-slate-50 py-16 lg:py-24 border-b border-slate-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-slate-600 leading-relaxed">
          Each service below has its own dedicated page with full details, timelines, packages and answers to the
          questions Nigerian founders ask most.
        </p>
      </div>
    </section>
